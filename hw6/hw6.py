...
poinEvals = [[], []]
bigT = (1/math.sqrt(g/l) * 2*math.pi) * math.pi/3
runlength = bigT * 150

t, theta = pend.solve([.01, 0], 1*10**-5, runlength)
print len(t)
...
pylab.xlim(-.014,.014)
pylab.ylabel('omega')
pylab.title('Simple Poincare Section')
pylab.savefig("test1a_irrat_00001_150.png", dpi=300)
pylab.show()